...
export default function Newsletter() {
  return (
    <div class="w-full flex py-12 mt-20 flex-col lg:flex-row gap-y-12 items-center justify-center gap-x-20 ">
      <div>
      ...
      <div>
        <div class="flex">
          <input type="email" placeholder="example@mail.com" className="w-96 searchColor px-8 py-2 text-white rounded-l-lg focus:outline-none"></input>
